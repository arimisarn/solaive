...
export default function InscriptionPage() {
  ...
  return (
    <>
      <section className="flex h-[220px] w-full items-center justify-center bg-accent px-4 text-center sm:h-[260px] md:h-[300px]">
        <div className="max-w-2xl">
          <h2 className="font-heading text-2xl font-bold tracking-tight text-accent-foreground sm:text-3xl">
            Rejoignez Solaive
          </h2>
          <p className="mt-3 text-sm text-accent-foreground/80 sm:text-base">
            Le tableau blanc collaboratif pour les équipes qui pensent et créent ensemble.
          </p>
        </div>
      </section>
